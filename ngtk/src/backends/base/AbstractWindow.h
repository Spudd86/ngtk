	...
	namespace Backends
	{
		namespace Base
		{
			...
			* since IGNORE is actually defined as a windows macro... */
			...
			{
				/* This window will ignore close events generated by the use
				 * it will respond however to events generated programmaticaly */
				WCB_IGNORE,
				/* Hide the window, keeping it valid */
				WCB_HIDE,
				/* Close the window, and free any resources allocated to it */
				WCB_CLOSE,
				/* Same as CLOSE, but also Quits the main Ngtk loop and close all
