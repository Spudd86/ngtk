...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/MinGW-Windows/libngtk.dll

dist/Release/MinGW-Windows/libngtk.dll: ${OBJECTFILES}
	${MKDIR} -p dist/Release/MinGW-Windows
	${LINK.cc} -shared -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libngtk.dll ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/src/backends/base/AbstractComponent.o: src/backends/base/AbstractComponent.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/backends/base/AbstractComponent.o src/backends/base/AbstractComponent.cpp
...
${OBJECTDIR}/src/backends/windows/WindowsComponent.o: src/backends/windows/WindowsComponent.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/backends/windows/WindowsComponent.o src/backends/windows/WindowsComponent.cpp

${OBJECTDIR}/src/backends/base/AbstractWidget.o: src/backends/base/AbstractWidget.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/backends/base
	${RM} $@.d
	$(COMPILE.cc) -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/backends/base/AbstractWidget.o src/backends/base/AbstractWidget.cpp

${OBJECTDIR}/src/backends/windows/WindowsContainer.o: src/backends/windows/WindowsContainer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/backends/windows
	${RM} $@.d
	$(COMPILE.cc) -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/backends/windows/WindowsContainer.o src/backends/windows/WindowsContainer.cpp

${OBJECTDIR}/src/backends/base/AbstractBackend.o: src/backends/base/AbstractBackend.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/backends/base
	${RM} $@.d
	$(COMPILE.cc) -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/backends/base/AbstractBackend.o src/backends/base/AbstractBackend.cpp

${OBJECTDIR}/src/events/MouseEvent.o: src/events/MouseEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/events
	${RM} $@.d
	$(COMPILE.cc) -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/events/MouseEvent.o src/events/MouseEvent.cpp

${OBJECTDIR}/src/backends/windows/WindowsWidget.o: src/backends/windows/WindowsWidget.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/backends/windows
	${RM} $@.d
	$(COMPILE.cc) -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/backends/windows/WindowsWidget.o src/backends/windows/WindowsWidget.cpp

${OBJECTDIR}/src/backends/windows/WindowsBackend.o: src/backends/windows/WindowsBackend.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/backends/windows
	${RM} $@.d
	$(COMPILE.cc) -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/backends/windows/WindowsBackend.o src/backends/windows/WindowsBackend.cpp
...
${OBJECTDIR}/src/backends/windows/WindowsWindow.o: src/backends/windows/WindowsWindow.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/backends/windows
	${RM} $@.d
	$(COMPILE.cc) -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/backends/windows/WindowsWindow.o src/backends/windows/WindowsWindow.cpp

${OBJECTDIR}/src/backends/base/AbstractContainer.o: src/backends/base/AbstractContainer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/backends/base
	${RM} $@.d
	$(COMPILE.cc) -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/backends/base/AbstractContainer.o src/backends/base/AbstractContainer.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/MinGW-Windows/libngtk.dll
