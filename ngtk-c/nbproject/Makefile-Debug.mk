...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/MinGW-Windows/ngtk-c.exe

dist/Debug/MinGW-Windows/ngtk-c.exe: ${OBJECTFILES}
...
${OBJECTDIR}/src/backends/windows/ngtk-win-base.o: src/backends/windows/ngtk-win-base.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/backends/windows/ngtk-win-base.o src/backends/windows/ngtk-win-base.c

${OBJECTDIR}/src/widgets/ngtk-event-generator.o: src/widgets/ngtk-event-generator.c 
	${MKDIR} -p ${OBJECTDIR}/src/widgets
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/widgets/ngtk-event-generator.o src/widgets/ngtk-event-generator.c

${OBJECTDIR}/src-test/main.o: src-test/main.c 
	${MKDIR} -p ${OBJECTDIR}/src-test
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src-test/main.o src-test/main.c
...
${OBJECTDIR}/src/backends/basic/ngtk-basic-component.o: src/backends/basic/ngtk-basic-component.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/backends/basic/ngtk-basic-component.o src/backends/basic/ngtk-basic-component.c

${OBJECTDIR}/src/backends/basic/ngtk-basic-event-generator.o: src/backends/basic/ngtk-basic-event-generator.c 
	${MKDIR} -p ${OBJECTDIR}/src/backends/basic
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/backends/basic/ngtk-basic-event-generator.o src/backends/basic/ngtk-basic-event-generator.c

${OBJECTDIR}/src/backends/windows/ngtk-widget-window.o: src/backends/windows/ngtk-widget-window.c 
	${MKDIR} -p ${OBJECTDIR}/src/backends/windows
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/backends/windows/ngtk-widget-window.o src/backends/windows/ngtk-widget-window.c

${OBJECTDIR}/src/object-system/ngtk-object.o: src/object-system/ngtk-object.c 
	${MKDIR} -p ${OBJECTDIR}/src/object-system
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/object-system/ngtk-object.o src/object-system/ngtk-object.c

${OBJECTDIR}/src/backends/basic/ngtk-basic-container.o: src/backends/basic/ngtk-basic-container.c 
	${MKDIR} -p ${OBJECTDIR}/src/backends/basic
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/backends/basic/ngtk-basic-container.o src/backends/basic/ngtk-basic-container.c

${OBJECTDIR}/src/widgets/ngtk-container.o: src/widgets/ngtk-container.c 
	${MKDIR} -p ${OBJECTDIR}/src/widgets
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/widgets/ngtk-container.o src/widgets/ngtk-container.c

${OBJECTDIR}/src/backends/windows/ngtk-win-component.o: src/backends/windows/ngtk-win-component.c 
	${MKDIR} -p ${OBJECTDIR}/src/backends/windows
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/backends/windows/ngtk-win-component.o src/backends/windows/ngtk-win-component.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/MinGW-Windows/ngtk-c.exe
